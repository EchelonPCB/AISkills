---
build_number: "001"
skill_id: "acdc.contracts.contract-gen"
name: "contract-gen"
...
| Requires   | `contract-type` output (acdc.contracts.contract-type)                    |
...
- `contract-type` (acdc.contracts.contract-type): Produces the parameter set this skill consumes. Can be bypassed if BoD provides all inputs directly.
