...
name: "chat-to-skill"
description: "Classify old AI chats and return complete governed AISkills skill files when repeatable workflows exist."
trigger_keywords: "chat, summarize, convert, workflow, extract skill, copy paste skill, epcb id, old AI chat"
owner: "EPCB"
status: "active"
...
| Input       | Raw chat, chat summary, chat history, existing skill names, repo context             |
| Output      | Classification, one complete skill.md, support-file plan, repo action  |
| Key Steps   | Select mode -> isolate source -> extract -> assemble -> validate       |
...
9.7 After the complete file block, return support-file plan, validation notes, and optional critique.
...
11.11 If any check fails, revise before returning output.
