...
name: "skill-mutation"
description: "Stage, validate, and promotion-gate a higher-risk mutated skill from two or more parent skills using command-generated evidence."
trigger_keywords: "mutation, combine, mutate skill, combine skills, skill mutation, merge workflows, staged skill validation, parent skill map, m command, promote mutation"
owner: "EPCB"
status: "active"
...
6. `mutation.json` — machine-readable parent lineage and staging metadata
7. `parents/` — snapshots of parent skill versions used for the mutation
...
- refuse promotion unless `validation-results.md` says `Recommendation: promote`
- refuse promotion while staged files contain unresolved draft markers
...
9. Promotion command completes repo validation after moving the candidate into `skills/`.
