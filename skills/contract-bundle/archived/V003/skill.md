...
2. Pair contracts to skills.
   ...
   2.3 If no skill exists and the user wants execution, route to `contract-to-skill` first or request the missing skill.
...
- If a contract has no associated skill and the task requires execution, create or request a contract skill before proceeding.
