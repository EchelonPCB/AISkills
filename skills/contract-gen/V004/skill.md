...
4. Missing-field blocker list or one concise clarification question when contract identity, authority, scope, or PASS semantics are unresolved
...
1.6 If a missing or conflicting answer would change contract identity, approval authority, destructive scope, or enforceable PASS semantics, ask one concise question before generation.
...
| missing or conflicting fact changes contract identity, authority, destructive scope, or enforceable PASS semantics | ask one concise question before generation |
...
- Do not ask broad exploratory questions. Ask at most one concise question unless the user explicitly requests an interactive drafting session.
- Do not generate contract-derived skills, bundle plans, or adjacent artifacts unless the user explicitly requests that next step.
- Do not bury a required clarification inside the generated contract or confirmation block.
...
## V004
- Added a CTS-style one-question clarification gate for authority, scope, and PASS-semantics conflicts before generation.
- Added explicit boundaries against auto-expanding contract generation into skills, bundles, or adjacent artifacts.
